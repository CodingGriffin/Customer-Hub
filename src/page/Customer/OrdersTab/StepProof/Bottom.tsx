...
function Bottom({pdfError, setIsUserManagementOpen, setIsRejectModalOpen, setIsApproveModalOpen}: BottomProps) {
  return (
    <div className="absolute bottom-0 left-0 right-0 bg-white p-4 shadow-lg z-40">
